...
for t1, t2, t3 in test : 
    ...
    print(f"({t1}, {t2}, {t3}) 평균온도 : {result:.2f}도")
print("-" * 20)
...
print("문제 2")
def prefer_lang(name, lang1, lang2) :
...
for name, lang1, lang2 in test :
    prefer_lang(name, lang1, lang2)
print("-" * 20)
...
for temps in test_list:
    ...
    result_rounded = [round(c, 2) for c in result]
    print(f"화씨 {temps} -> 섭씨 {result_rounded}")
print("-" * 20)
